...
//    public PhotoPicker facilityPhotoPicker;
    public PhotoPicker eventPhotoPicker; // Initialized in MainActivity
    public PhotoPicker.PhotoPickerCallback eventPhotoPickerCallback; // Will be set in CreateEventFragment
